...
const flubImpl = v => "???";
const defaultOptions = {foo: 42, baz: $mData$dMaybe.Nothing};
const test1 = /* #__PURE__ */ flubImpl({...defaultOptions, bar: "Hello"});
const test2 = /* #__PURE__ */ flubImpl({...defaultOptions, foo: 99, bar: "Hello"});
const test3 = /* #__PURE__ */ flubImpl({...defaultOptions, foo: 99, baz: /* #__PURE__ */ $mData$dMaybe.$Maybe("Just", true), bar: "Hello"});
const test4 = /* #__PURE__ */ flubImpl({...defaultOptions, foo: 99, baz: /* #__PURE__ */ $mData$dMaybe.$Maybe("Just", true), bar: "42"});
