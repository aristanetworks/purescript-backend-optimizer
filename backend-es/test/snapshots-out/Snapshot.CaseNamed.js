...
const test2 = v => {
  ...
  return Data$dShow.showIntImpl(v._1) + (
    Data$dShow.showIntImpl(v._1) + (Data$dShow.showIntImpl(v._2) + (Data$dShow.showIntImpl(v._2) + (Data$dShow.showIntImpl(v._3) + Data$dShow.showIntImpl(v._3))))
  );
};
const test1 = v => {
