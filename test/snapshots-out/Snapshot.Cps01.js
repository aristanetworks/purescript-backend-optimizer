...
bindState = {bind: v => k2 => next1 => s1 => v(s2 => a => k2(a)(next1)(s2))(s1), Apply0: () => applyState};
applyState = {apply: f => a => next1 => s1 => f(s2 => a_1 => a(s2_1 => a_2 => applicativeState.pure(a_1(a_2))(next1)(s2_1))(s2))(s1), Functor0: () => functorState};
applicativeState = {pure: a => next => s1 => next(s1)(a), Apply0: () => applyState};
