...
const bindState = {bind: k1 => k2 => (k$p, s) => k1((_4, _5) => k2(_5)((_6, _7) => k$p(_6, _7), _4), s), Apply0: () => applyState};
const applyState = {apply: f => a => (k$p, s) => f((_4, _5) => a((_6, _7) => applicativeState.pure(_5(_7))((_8, _9) => k$p(_8, _9), _6), _4), s), Functor0: () => functorState};
